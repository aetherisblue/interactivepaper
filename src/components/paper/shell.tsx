          ...
          <main className="px-4 pt-10 pb-24 sm:px-8 lg:px-12 lg:pt-14">
            ...
            <footer className="mt-16 border-t border-rule pt-8">
              <p className="font-sans text-sm leading-relaxed text-muted">
                ...
                matrix. Figures 1–3 are live: choose a meeting in the matrix to
                see its complementary pools, then watch the native frame become
                the unit step <span className="text-ink">+1 / −1</span>.
              </p>
            </footer>
          </main>
        </div>
