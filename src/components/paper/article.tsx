    ...
    <article className="paper-prose">
      <section id="abstract" className="scroll-mt-24">
        ...
        <p className="text-[1.05rem] leading-[1.65] text-ink-soft sm:text-lg">
          ...
          not the integer 1. The matrix is first read as
      ...
      <section id="s2" className="scroll-mt-24">
        ...
        <p>
          ...
          yet supply is a unit in which motion between pools can be measured.
          That unit arrives in §3, when a pool is allowed to serve as its own
          logarithmic base. §4.3 records what happens if one keeps the pools
          and the operators but withholds the internal frame: the picture stays
          a metaphor.
        </p>
      </section>

      <section id="s3" className="scroll-mt-24">
        <SectionHead n="3" title="The successful correspondence" />
        <p>
          Fix any positive entry <Tex i>{String.raw`r=R(m,n)`}</Tex> with{" "}
          <Tex i>{String.raw`r\neq 1`}</Tex>. Taking the logarithm with base{" "}
          <Tex i>r</Tex> itself yields
        </p>
        <Tex numbered="4">{String.raw`\log_{r}(r)=+1,\qquad \log_{r}\bigl(\tfrac{1}{r}\bigr)=-1.`}</Tex>
        <p>
        ...
        <Tex numbered="5">{String.raw`\log_{r}(r)=\frac{\ln r}{\ln r}=+1,\qquad \log_{r}\bigl(\tfrac{1}{r}\bigr)=\frac{\ln(1/r)}{\ln r}=-1.`}</Tex>
        <p>
      ...
      <section id="s4" className="scroll-mt-24">
        <SectionHead n="4" title="Approaches that did not work" />
        <p>
      ...
      <Failure
        ...
        lesson={
          <p>
            ...
            base of §3 converts a multiplicative jump into a unit additive
      ...
      <section id="s5" className="scroll-mt-24">
        <SectionHead n="5" title="Why the native-base reading succeeds" />
        <p>
      ...
      <section id="s6" className="scroll-mt-24">
        <SectionHead n="6" title="Open directions that remain legitimate" />
        <p>
        ...
        <p>
          ...
          of those simplifications would turn the single observation of §3 into
          a catalogue of internal unit communications.
        </p>
        <p>
          <strong className="font-medium text-ink">
            6.2 Paths of successive unit steps.{" "}
          </strong>
      ...
      <section id="s7" className="scroll-mt-24">
        <SectionHead n="7" title="Conclusion" />
        <p>
